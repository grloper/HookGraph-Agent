...
HookGraph-Agents turns that workflow into a deterministic, auditable agent graph:
...
```
                              HookGraph-Agents graph topology
 ┌─────────────────────────────────────────────────────────────────────────────────┐
 │                                                                                 │
 │   START                                                                         │
...
```bash
git clone https://github.com/grloper/HookGraph-Agents.git
cd HookGraph-Agents
